...
\title{Detecting Student Progress during Programming Activities by Analyzing Edit Operations on their Blocks-Based Programs}

\author{Mark A. Sherman}

\prevdegrees{M.S., University of Massachusetts Lowell (2010) \\ B.S., University of Massachusetts Lowell (2008)}
...
\degreemonth{April}
\degreeyear{2017}
\thesisdate{April 19, 2017}

% If there is more than one supervisor, use the \supervisor command
% once for each.
\supervisor{Fred G. Martin}{Professor}
\reader{Jay McCarthy}{Associate Professor}
