...
\title{Proposal: \\ Learning Analytics for Block-based Programming: \\ In search of the ``Flailing Detector''}
...
\supervisor{John McCarthy}{Associate Professor}
\supervisor{Franklyn A. Turbak}{Associate Professor, Wellesley College}

% this is the department committee chairman, not the thesis committee chairman. 
\chairman{Hiam Levkowitz}{Department Chairman}
